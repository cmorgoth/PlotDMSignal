...
int RatioPlotsBandV2(TH1F* h1, TH1F* h2, TString h1Name = "h1Name", TString h2Name = "h2Name", TString fname = "default_name", TString type = "defaultType", int nbins = 0, float* bins = NULL, int color = 0){
  ...
  if(h1->GetBinContent(nbins) != 0.0){
    if(h2->GetBinContent(nbins)-h2->GetBinError(nbins) >0){
      h1->GetYaxis()->SetRangeUser(0.02*(h2->GetBinContent(nbins)-h2->GetBinError(nbins)), 2.0*h1->GetBinContent(1));
    }else{
...
int RatioPlotsV3(THStack* s, TH1F* h1, TH1F* h2, TString h1Name = "h1Name", TString h2Name = "h2Name", TString fname = "default_name", TString type = "defaultType", int nbins = 0, float* bins = NULL, TLegend* le = NULL, TString y_axis = "Events"){
  ...
  s->Draw();
  if(type == "MET"){
    s->GetYaxis()->SetTitle("Events/75 GeV");
  }else{
...
int RatioPlotSignal(THStack* s, TH1F* h1, TH1F* h2, TString h1Name = "h1Name", TString h2Name = "h2Name", TString fname = "default_name", TString type = "defaultType", int nbins = 0, float* bins = NULL, TLegend* le = NULL, TString y_axis = "Events", TH1F* signal = NULL){
